...
from keras.layers import Input, Reshape, Dense, Dropout, MaxPooling2D, Conv2D, Flatten, LSTM
...
def generator_model():
    ...
    ### LSTM model
    inputs = Input((10,))
    fc1 = Dense(input_dim=10,units=100*10)(inputs)
    fc1 = BatchNormalization()(fc1)
    fc1 = LeakyReLU(0.2)(fc1)
    fc1 = Reshape((100,10))(fc1)
    lstm1 = LSTM(32,input_dim=10,return_sequences=True)(fc1)
...
def discriminator_model():
    ...
    inputs = Input((100,1,))
    lstm1 = LSTM(100,input_dim=1)(inputs)
    fc1 = Dense(1)(lstm1)
...
def feature_extractor(d=None):
    ...
    intermidiate_model = Model(inputs=d.layers[0].input, outputs=d.layers[-2].output)     ####-5 for simple model,-7 for CNN model
