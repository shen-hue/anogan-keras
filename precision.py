...
score = np.load('result_artificial/test_diff.npy')
# diff = diff.reshape(-1,6)
# score = np.sum(abs(diff), axis=1)
...
# y_test = np.load('result_artificial/y_test.npy').reshape(1000000)
y_test = np.concatenate([[0] * 850000, [1] * 150000], axis=0)
